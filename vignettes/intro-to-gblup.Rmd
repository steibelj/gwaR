...
- Accepts `gpData` objects from package `synbreed` as input data or it can use a data.frame containing phenotypes and covariates such as those used for the `rrblup` package
